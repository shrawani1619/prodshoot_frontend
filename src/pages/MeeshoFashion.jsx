    ...
    return (
        <div className="page-wrapper">
            ...
            <section className="service-hero">
                <div className="service-hero-content">
                    ...
                    >
                        <motion.div className="hero-badge" variants={fadeUp}>
                            ...
                            FASHION & APPAREL FOR MEESHO
                        </motion.div>

                        <motion.h1 className="service-hero-title display-bold" variants={fadeUp}>
                            Fashion Photography<br />That Drives Trends on<br />Meesho
                        </motion.h1>

                        <motion.p className="service-hero-desc" variants={fadeUp}>
                            Whether it's ethnic wear, western fashion, or activewear, we capture the movement, fit, and style of your garments. Ghost mannequin or model — we provide images that make your apparel the star on Meesho.
                        </motion.p>
                ...
                >
                    <img src="/fashion-lifestyle.png" alt="Meesho fashion photography" />
                </motion.div>
            </section>
            ...
            <section className="service-section">
                <div className="service-section-grid">
                    <div className="service-section-text">
                        <span className="section-label-sm">FASHION EXPERTS</span>
                        <h2 className="service-section-title display-bold">Fit, Flow, and Fabric Focus</h2>
                        <p className="service-section-desc">
                            Clothing on Meesho needs to look approachable yet high-end. We focus on showing the fit accurately to reduce returns and use lighting that makes colors pop without artificial distortion.
                        </p>
                        <ul className="feature-checklist">
                            {[
                                "Ghost mannequin (hollow man) effect",
                                "Professional model sourcing available",
                                "Wrinkle-free post-production",
                                "Detailed stitching and fabric close-ups",
                                "Consistent lighting across catalogs",
                                "Meesho guideline approved files"
                            ].map((f, i) => (
                                <motion.li
                                    key={i}
