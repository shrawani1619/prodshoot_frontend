...
const IMGS = {
    ...
    frontCloth: 'https://images.unsplash.com/photo-1602810319428-019690571b5b?w=600&q=80',
    ...
    womens:     'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=600&q=80',
...
function AjioPhotography() {

    const features = [
        'Ajio marketplace-ready images approved on first submission',
        'Premium fashion photography style matching Ajio brand standards',
        'Professional model-based shoots with expert styling and grooming',
        'Front, back, side, flat-lay, and lifestyle angles — full coverage',
    ...
    const process = [
        {
            ...
            desc: 'Courier your garments to our studio. We steam, press, and style every piece before the shoot begins.'
        },
        {
            step: '02',
            icon: <Camera size={24} />,
            title: 'Professional Studio or Model Shoot',
            desc: 'Our team shoots on live models, ghost mannequins, and flat-lay setups with premium softbox lighting rigs.'
        },
        {
            step: '03',
            icon: <Image size={24} />,
    ...
    const gallery = [
        ...
        { img: IMGS.frontCloth, caption: 'Front View Clothing' },
        { img: IMGS.backView,   caption: 'Back View' },
        { img: IMGS.lifestyle,  caption: 'Lifestyle Fashion Shoot' },
    ...
    const whyCards = [
        {
            ...
            desc: 'Every image delivered in exact Ajio spec — correct dimensions, minimal backgrounds, and zero watermarks — approved every time.'
        },
        {
            icon: <Sparkles size={24} />,
            title: 'Premium Fashion Style',
            desc: "Ajio's upscale aesthetic demands editorial quality. Our shoots match that premium look — clean, bold, and brand-forward."
        },
        {
            icon: <Maximize2 size={24} />,
            title: 'High Resolution & Zoom-Ready',
            desc: 'Minimum 2000×2000 px delivery so Ajio shoppers can inspect every fabric detail, button, and stitch at full zoom.'
        },
        {
            icon: <Lightbulb size={24} />,
            title: 'Professional Lighting & Styling',
            desc: 'Softbox and diffused studio lighting reveals weave, texture, print, and embroidery with maximum visual clarity.'
        },
        {
            icon: <Layers size={24} />,
            title: 'Consistent Brand Catalog Visuals',
            desc: 'Uniform lighting, angles, and post-production across every SKU ensures your entire range looks cohesive and premium.'
        },
    ];
    ...
    const testimonials = [
        {
            ...
            text: "Prodshoot understands Ajio's premium aesthetic perfectly. Our dresses and co-ord sets look absolutely editorial. CTR went up 44% in the first three weeks."
        },
        {
            name: 'Vikram Sinha', role: "Men's Apparel Seller — Ajio", rating: 5,
            text: 'The shirt and chino model shots are sharp, clean, and perfectly match the premium look Ajio expects. Zero rejections across our entire 400-SKU catalogue.'
        },
        {
            name: 'Deepa Nair', role: 'Ethnic Wear Brand — Ajio', rating: 5,
            text: 'Our kurta and saree collections finally look the way they deserve to. The colour accuracy and fabric detail in every image drove a 30% drop in return rates.'
        },
    ];
    ...
    return (
        <div className="page-wrapper">
            ...
            <section className="service-hero">
                <div className="service-hero-content">
                    <motion.div initial="initial" animate="animate" variants={stagger}>
                        <motion.div className="hero-badge" variants={fadeUp}>
                            ...
                            AJIO PRODUCT PHOTOGRAPHY
                        </motion.div>

                        <motion.h1 className="service-hero-title display-bold" variants={fadeUp}>
                            Ajio Product<br />Photography<br />That Sells
                        </motion.h1>

                        <motion.p className="service-hero-desc" variants={fadeUp}>
                            Premium fashion product photography designed specifically for Ajio marketplace listings. Model shoots, flat-lay, and lifestyle — every image built to Ajio's high standards.
                        </motion.p>
                        ...
                        <motion.div className="service-hero-actions" variants={fadeUp}>
                            <Link to="/contact" style={{ textDecoration: 'none' }}>
                                ...
                                >
                                    <Send size={18} />
                                    BOOK AJIO PHOTOSHOOT
                                </motion.div>
                            </Link>
                            <a href="#ajio-gallery" className="cta-secondary-btn">
                ...
                >
                    <img src={IMGS.hero} alt="Ajio fashion product photography" />
                </motion.div>
            </section>
            ...
            {/* ─── WHY PROFESSIONAL AJIO PHOTOGRAPHY ─── */}
            <section className="service-section">
                <div className="service-section-grid">
                    <div className="service-section-text">
                        <span className="section-label-sm">WHY IT MATTERS</span>
                        <h2 className="service-section-title display-bold">Why Professional Photography Wins on Ajio</h2>
                        <p className="service-section-desc">
                            Ajio positions itself as a premium fashion destination. Listings with editorial-quality images outperform ordinary product photos by a wide margin. We deliver images that match the Ajio aesthetic — minimal, sharp, and premium — every single time.
                        </p>
                    ...
                    {categories.map((cat, idx) => (
                        ...
                        >
                            ...
                            <div className="flipkart-service-body">
                                <h3>{cat.label}</h3>
                                <p>Dedicated model or studio setup, premium lighting, and expert post-production — delivered Ajio-ready.</p>
            ...
            <section className="service-section">
                <div className="section-heading" style={{ maxWidth: '1440px', margin: '0 auto', padding: '0 2rem' }}>
                    ...
                    <p>Real Results from Real Ajio Fashion Brands</p>
                </div>
                ...
                <div style={{ maxWidth: '1440px', margin: '0 auto', padding: '0 2rem' }}>
                    ...
                    >
                        ...
                        <div className="bottom-cta-content">
                            ...
                            <p>
                                Ship us your garments — we deliver Ajio-ready images that match the platform's premium aesthetic and turn browsers into buyers.
                            </p>
                        </div>
...
export default AjioPhotography;
