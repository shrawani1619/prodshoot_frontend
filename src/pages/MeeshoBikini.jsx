    ...
    return (
        <div className="page-wrapper">
            ...
            <section className="service-hero">
                <div className="service-hero-content">
                    ...
                    >
                        <motion.div className="hero-badge" variants={fadeUp}>
                            ...
                            BIKINI & LINGERIE PHOTOGRAPHY FOR MEESHO
                        </motion.div>

                        <motion.h1 className="service-hero-title display-bold" variants={fadeUp}>
                            Elegant & Professional<br />Bikini Photography for<br />Meesho
                        </motion.h1>

                        <motion.p className="service-hero-desc" variants={fadeUp}>
                            Expertly captured bikini and intimate wear photography. We focus on fit, fabric, and respectful professional styling that meets Meesho's community standards while maximizing the visual appeal of your collection.
                        </motion.p>
                ...
                >
                    <img src="/fashion-lifestyle.png" alt="Meesho bikini photography" />
                </motion.div>
            </section>
            ...
            <section className="service-section">
                <div className="service-section-grid">
                    <div className="service-section-text">
                        <span className="section-label-sm">INTIMATES SPECIALISTS</span>
                        <h2 className="service-section-title display-bold">Professional Fit & Style</h2>
                        <p className="service-section-desc">
                            Intimate wear requires careful styling to ensure the fit is represented accurately. We use specialized lighting that highlights the softness and texture of the fabric without creating harsh contrasts.
                        </p>
                        <ul className="feature-checklist">
                            {[
                                "Respectful professional model shoots",
                                "Ghost mannequin options for product-only",
                                "Soft-lit fabric texture detail",
                                "Skin-tone accurate color grading",
                                "Clean, distraction-free backgrounds",
                                "Compliant with Meesho community guidelines"
                            ].map((f, i) => (
                                <motion.li
                                    key={i}
