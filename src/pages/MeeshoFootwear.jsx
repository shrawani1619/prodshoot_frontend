    ...
    return (
        <div className="page-wrapper">
            ...
            <section className="service-hero">
                <div className="service-hero-content">
                    ...
                    >
                        <motion.div className="hero-badge" variants={fadeUp}>
                            ...
                            FOOTWEAR PHOTOGRAPHY FOR MEESHO
                        </motion.div>

                        <motion.h1 className="service-hero-title display-bold" variants={fadeUp}>
                            Walk into Success with<br />Meesho Footwear<br />Photography
                        </motion.h1>

                        <motion.p className="service-hero-desc" variants={fadeUp}>
                            Specialized footwear photography designed to highlight materials, stitching, and comfort. We help your shoes and sandals stand out on Meesho with professional lighting and perfect angles.
                        </motion.p>
                ...
                >
                    <img src="/portfolio-sneakers.png" alt="Meesho footwear photography" />
                </motion.div>
            </section>
            ...
            <section className="service-section">
                <div className="service-section-grid">
                    <div className="service-section-text">
                        ...
                        <h2 className="service-section-title display-bold">Texture and Detail Focused Shoot</h2>
                        <p className="service-section-desc">
                            Footwear requires specific angles to show height, soul pattern, and material texture. Our studio is equipped with multi-point lighting that eliminates shadows and highlights the premium look of your footwear line.
                        </p>
                        <ul className="feature-checklist">
                            {[
                                "360-degree angle coverage",
                                "Material texture highlighting",
                                "Consistent shadows and lighting",
                                "Pure white background compliance",
                                "High-resolution for detail zoom",
