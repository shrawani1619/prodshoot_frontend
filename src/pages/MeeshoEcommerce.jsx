    ...
    return (
        <div className="page-wrapper">
            ...
            <section className="service-hero">
                <div className="service-hero-content">
                    ...
                    >
                        <motion.div className="hero-badge" variants={fadeUp}>
                            ...
                            E-COMMERCE CATALOGING FOR MEESHO
                        </motion.div>

                        <motion.h1 className="service-hero-title display-bold" variants={fadeUp}>
                            High-Volume Cataloging<br />for Rapid Meesho<br />Scaling
                        </motion.h1>

                        <motion.p className="service-hero-desc" variants={fadeUp}>
                            Scale your Meesho store with our efficiency-driven cataloging service. We handle mass production of high-quality product images, ensuring every SKU is shot to the same elite standard.
                        </motion.p>
                ...
                >
                    <img src="/catalog.png" alt="Meesho e-commerce cataloging" />
                </motion.div>
            </section>
            ...
            <section className="service-section">
                <div className="service-section-grid">
                    <div className="service-section-text">
                        <span className="section-label-sm">SCALE SPECIALISTS</span>
                        <h2 className="service-section-title display-bold">Consistency at Scale</h2>
                        <p className="service-section-desc">
                            Managing hundreds of SKUs requires a systematic approach. Our studio uses automated workflows to ensure that the first shot is identical in quality to the five-hundredth shot, maintaining your brand's professional look on Meesho.
                        </p>
                        <ul className="feature-checklist">
                            {[
                                "Batch processing for high SKU counts",
                                "Unified lighting setups",
                                "Rapid 48-72 hour turnaround",
                                "Smart file naming for inventory sync",
                                "Bulk retouching and post-production",
                                "Direct upload-ready formats"
                            ].map((f, i) => (
                                <motion.li
                                    key={i}
...
export default MeeshoEcommerce;
