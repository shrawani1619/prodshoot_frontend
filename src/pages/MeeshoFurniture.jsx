    ...
    return (
        <div className="page-wrapper">
            ...
            <section className="service-hero">
                <div className="service-hero-content">
                    ...
                    >
                        <motion.div className="hero-badge" variants={fadeUp}>
                            ...
                            FURNITURE PHOTOGRAPHY FOR MEESHO
                        </motion.div>

                        <motion.h1 className="service-hero-title display-bold" variants={fadeUp}>
                            Large-Scale Furniture<br />Visuals for the Meesho<br />Catalog
                        </motion.h1>

                        <motion.p className="service-hero-desc" variants={fadeUp}>
                            Managing large items on Meesho requires professional scale. We provide spacious studio setups and expert handling for furniture, decor, and home essentials, ensuring they look perfect in every listing.
                        </motion.p>
                ...
                >
                    <img src="/lifestyle.png" alt="Meesho furniture photography" />
                </motion.div>
            </section>
            ...
            <section className="service-section">
                <div className="service-section-grid">
                    <div className="service-section-text">
                        <span className="section-label-sm">DECOR SPECIALISTS</span>
                        <h2 className="service-section-title display-bold">Texture and Build Clarity</h2>
                        <p className="service-section-desc">
                            Furniture buyers on Meesho look for build quality and material finish. We use wide-angle lenses and specialized floor-to-ceiling lighting to show the true scale and quality of your home decor products.
                        </p>
                        <ul className="feature-checklist">
                            {[
                                "Large-item studio capacity",
                                "Wood and fabric texture detail",
                                "Structural build highlighting",
                                "Clean isolation in large frames",
                                "Consistent color across sets",
                                "Optimized for Meesho mobile app"
                            ].map((f, i) => (
                                <motion.li
                                    key={i}
...
export default MeeshoFurniture;
